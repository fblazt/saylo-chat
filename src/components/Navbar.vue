<template>
  <div class="h-16 w-full px-3 py-1 fixed flex flex-row justify-between items-center bg-gray-900 text-white">
    <div>
      <img src="@/assets/img/saylo_transparent.png" width="45px" alt="Saylo Logo">
    </div>
    <div class="flex flex-row-reverse items-center bg-blue-600 p-1 rounded-full lg:flex-row lg:bg-transparent lg:p-0 lg:rounded-none">
